...
public class Desktop extends Computador {
    ...
    public void cadastrar() {
        ...
        setPlacasVideo(scanner.nextInt());
        scanner.nextLine();
        System.out.print("Marca da Placa de Vídeo: ");
        setMarcaPlacaVideo(scanner.nextLine());
    }
    ...
    public void imprimir() {
        ...
        System.out.println("Placa de Vídeo: " + getMarcaPlacaVideo() + " (" + getPlacasVideo() + " unidade(s))");
        System.out.println("--------------------------------");
    }
}